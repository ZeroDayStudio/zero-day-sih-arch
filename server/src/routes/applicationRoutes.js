...
const { createApplication, getMyApplications, getOpportunityApplications, updateApplicationStatus } = require('../controllers/applicationController');
...
router.get('/opportunity/:opportunityId', authorize('employer'), getOpportunityApplications);
